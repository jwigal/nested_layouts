...
This plugin was originally written by Maxim Culkin 
(maxim_culkin@gmail.com)

Forked by Jeff Wigal (jeff@referee-assistant.com), patched to be 
...
If you encounter any bugs or has some feature proposal, feel free to 
email it to jeff@referee-assistant.com.
